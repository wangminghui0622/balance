...
export const ROUTE_PATH = {
  ...
  SELECT_ROLE: '/pages/register/select-role',
  // 店铺端
  SHOPOWNER_HOME: '/shopower/pages/home/home',
  SHOPOWNER_STORES: '/shopower/pages/stores/stores',
  SHOPOWNER_ORDERS: '/shopower/pages/orders/orders',
  // 运营端
  OPERATOR_HOME: '/operator/pages/home/home',
  // 平台端
  PLATFORM_HOME: '/platform/pages/home/home'
} as const
...
export const USER_TYPE_TO_ROUTE: Record<UserType, string> = {
  [USER_TYPE.PLATFORM]: ROUTE_PATH.PLATFORM_HOME,
  [USER_TYPE.OPERATOR]: ROUTE_PATH.OPERATOR_HOME,
  [USER_TYPE.SHOPOWNER]: ROUTE_PATH.SHOPOWNER_HOME
} as const
