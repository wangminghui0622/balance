  ...
  <view class="home-page">
    ...
    <view class="menu-grid">
      <view class="menu-item">
        ...
        <text class="label">代运营店铺</text>
      </view>
      <view class="menu-item">
        <view class="icon orders">📦</view>
        <text class="label">订单处理</text>
      </view>
      <view class="menu-item">
        <view class="icon finance">💰</view>
        <text class="label">佣金结算</text>
      </view>
      <view class="menu-item">
